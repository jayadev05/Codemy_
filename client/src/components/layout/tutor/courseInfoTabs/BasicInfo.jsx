...
function BasicInfo({initialData, sendData}) {
    ...
    const [selectedLanguage, setSelectedLanguage] = useState(initialData?.language || 'default');
    const [selectedDifficulty, setSelectedDifficulty] = useState(initialData?.difficulty || 'default');
