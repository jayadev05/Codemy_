...
import { Check, X, Send, AlertCircle, Bell, LogOut, User, Settings, Search, CheckCircle, XCircle, Clock } from 'lucide-react'
...
const StatusBadge = ({ status }) => {
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-medium ${styles[status.toLowerCase()]}`}>
 ...
 useEffect(() => {
  ...
  return (
    ...
    <AdminHeader heading="Report Management"/>
      ...
      <Pagination  className="mb-8 flex justify-center"  totalData={filteredReports.length} dataPerPage={dataPerPage} currentPage={currentPage} setCurrentPage={setCurrentPage}/>
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="flex justify-end space-x-2">
              ...
              <button
                onClick={()=>handleReport(selectedReport._id,selectedReport.reportedBy._id)}
