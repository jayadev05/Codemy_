  ...
  const dummyUsers = [
    ...
    },
    {
      ...
      credentials: [
        ...
        "Blockchain in Finance Certification",
      ],
      isActive: true,
      isVerified: true,
