          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <p className="text-xl text-orange-100 max-w-3xl">
                {course.shortDescription || "Embark on a journey of knowledge and skill development with our expertly crafted course."}
              </p>
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                ...
                <button className="px-8 py-3 bg-orange-700 text-white rounded-full font-semibold text-lg hover:bg-orange-800 transition-colors">
                  Add to Cart
                </button>
              </div>
            </div>
            <div className="md:w-1/2 relative">
              <div className="aspect-video rounded-lg overflow-hidden shadow-xl">
                <img 
                  src={course.thumbnail || "/placeholder.svg?height=720&width=1280"}
                  alt="Course preview"
              ...
              <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-lg shadow-lg">
                <div className="text-3xl font-bold text-orange-600">₹{course?.price?.$numberDecimal}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            <section className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-800">Course Description</h2>
              <p className="text-gray-600">{course.description}</p>
            </section>

            <section className="mb-8 bg-orange-50 p-6 rounded-lg">
              <h2 className="text-2xl font-bold mb-4 text-gray-800">What you will get in this course</h2>
            ...
            <section>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800">{course.tutorId?.fullName}</h3>
                  <p className="text-gray-600 text-sm mb-2">{course.tutorId?.jobTitle}</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 sticky top-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-gray-800">₹{course?.price?.$numberDecimal}</span>
{user && <button 
                   onClick={() => handleWishlist(course._id)}
                  className="p-2 text-gray-500 hover:text-orange-500 transition-colors" aria-label="Add to Wishlist">
        ...
        <section className="mt-12">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Course Rating</h2>
          <div className="flex items-start gap-12">
            <div className="text-center">
              <div className="text-5xl font-bold mb-2 text-gray-800">{averageRating}</div>
            ...
            <div className="flex-1">
              {[5, 4, 3, 2, 1].map(rating => (
                <div key={rating} className="flex items-center gap-2 mb-2">
                  ...
                  <div className="text-sm text-gray-600 w-10">{ratingPercentages[rating]}%</div>
                </div>
              ))}
            </div>
          </div>
