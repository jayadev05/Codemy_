    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-neutral-100 overflow-hidden">
        <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 text-center py-8 px-6">
          ...
          <h1 className="text-3xl font-extrabold text-white mb-2">Purchase Complete</h1>
          <p className="text-emerald-100 text-base">Thank you for investing in your learning journey</p>
        </div>
          ...
          <div>
            ...
            <div className="bg-emerald-50 rounded-lg p-4 space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-neutral-600 font-medium">Order Number</span>
                <span className="text-neutral-800 font-semibold">{order.orderId}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-600 font-medium">Payment ID</span>
                <span className="text-neutral-800 font-semibold">{order.payment?.paymentId}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-neutral-600 font-medium">Total Amount</span>
                <span className="text-emerald-600 font-bold">₹{order.totalAmount/100}</span>
              </div>
            </div>
          </div>
