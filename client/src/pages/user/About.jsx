...
<Header/>
      ...
      <section className="container mx-auto px-4 mb-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {stats.map((stat) => (
            <Card key={stat.label} className="border-none shadow-sm bg-white/50 backdrop-blur">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Access course content 24/7 and learn on your schedule</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Connect with fellow learners and get help when needed</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Instructors Section */}
      <section className="container mx-auto px-4 mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Meet Our Expert Instructors</h2>
        <div className="grid md:grid-cols-3 gap-6">
          {instructors.map((instructor) => (
            <Card key={instructor.name} className="border-none shadow-sm">
